      ...
      <section id="about" className="section">
        <div className="container">
          <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12 reveal-up">
            ...
            Welcome! I'm Sanjay, a 2nd-year B.Tech student passionate about web development. I specialize in building clean, responsive, and user-friendly websites that not only look great but also deliver smooth performance. With a growing skillset and a strong eye for design and functionality, I turn ideas into impactful digital experiences.
            </p>
