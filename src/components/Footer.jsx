    ...
    <footer className="section">
        ...
        <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="mb-10">
                ...
                <a href="sanjusanjay0444@gmail.com" target="_self" class="btn btn-primary flex items-center gap-2 px-4 py-2 w-fit reveal-up">
                  Start project
        ...
        <div className="flex items-center justify-between pt-10 mb-8">
            ...
            <p className="text-zinc-500 text-sm reveal-up">
                &copy; 2025 <span className="text-zinc-200">Sanjay S</span>
            </p>
        </div>
