...
const socialLinks = [
    {
      href: 'https://github.com/sanju-github24',
    ...
    {
      href: 'https://www.instagram.com/classy_2407/',
...
const Contact = () => {
  return (
   <section id="contact" className="section">
    ...
    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] ;g:max-w-[30ch] reveal-up">
    ...
    <form action="https://getform.io/f/adrgevra" method="POST" className="xl:pl-10 2xl:pl-20">
 
       <div className="md:grid md:items-centermd:grid-cols-2 md:gap-2">
        <div className="mb-4">
            <label htmlFor="name" className="label reveal-up">
                Name
            </label>

         <input type="text" name="name" id="name" autoComplete="name" required placeholder="Sanjay S" className="text-field reveal-up" />
        </div>
        ...
        <div className="mb-4">
         ...
         <input type="email" name="email" id="email" autoComplete="name" required placeholder="" className="text-field reveal-up" />
        </div>
       </div>
